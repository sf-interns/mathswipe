...
var $, AdjacentCellsCalculator, Board, BoardSolvedServce, Cell, ClickHandler, Colors, DFS, ExpressionGenerator, GoalContainer, InputSolver, MathSwipeController, RandomizedFitLength, ResetButton, SolutionService, Tuple,
...
MathSwipeController = (function() {
  ...
  MathSwipeController.prototype.initialize = function() {
    ...
    this.board = new Board(gameModel, this.gameScene, Cell, Colors, ClickHandler, SolutionService, answers, boardSymbols, this.goalContainer, BoardSolvedServce);
