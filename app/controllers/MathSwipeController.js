...
var $, AdjacentCellsCalculator, Board, Cell, ClickHandler, Colors, DFS, ExpressionGenerator, GoalContainer, InputSolver, MathSwipeController, RandomizedFitLength, ResetButton, SolutionService, TouchHandler, Tuple,
...
MathSwipeController = (function() {
  ...
  MathSwipeController.prototype.initialize = function() {
    var answers, boardSymbols, expression, gameModel, goalsSymbols, handler, i, inputLengths, inputSize, inputs, k, l, len, len1, length;
    length = 3;
    inputs = [];
    answers = [];
