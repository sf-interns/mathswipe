class Board
  ...
  constructor: (@boardValues, @scene, @goals, @symbols, @goalContainer, @Cell, @Colors, @ClickHandler, @SolutionService, @BoardSolvedService, @RunningSum) ->
  ...
  initializer: =>
    ...
    @clickHandler = new @ClickHandler this, @two, solutionService, @goalContainer, @BoardSolvedService, @RunningSum
